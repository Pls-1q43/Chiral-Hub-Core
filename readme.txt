...
= 1.1.2 =
1. Fixed duplicate Chiral Data CPT creation by making REST creates idempotent for the same source node article.
2. Preserved existing Chiral Data slugs when duplicate create requests are converted into updates.
